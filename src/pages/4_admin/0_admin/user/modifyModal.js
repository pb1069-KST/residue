...
export const ModifyModal = () => {
  ...
  const { dataSource, isvisible_modify_modal, datasource_mod_modal } =
          ...
          footer={
            <div>
              <Popconfirm
                ...
                onConfirm={() => {
                  var data = _.cloneDeep(datasource_mod_modal);
              ...
              >
                <Button
                  ...
                  size="small"
                  disabled={
                    datasource_mod_modal.USERID === undefined ||
                    datasource_mod_modal.USERID === "" ||
                    datasource_mod_modal.USERID === null ||
                    datasource_mod_modal.USERNAME === "" ||
                    datasource_mod_modal.USERNAME === undefined ||
                    datasource_mod_modal.USERNAME === null
                  }
                >
                  등록
                </Button>
                ...
                dataSource={[
                  {
                    ...
                    data_1: (
                      <Input
                        size="small"
                        value={datasource_mod_modal.USERID}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceModModal({
                  ...
                  },
                  {
                    ...
                    data_1: (
                      <Input
                        size="small"
                        value={datasource_mod_modal.USERNAME}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceModModal({
                              ...datasource_mod_modal,
                  ...
                  },
                  {
                    ...
                    data_1: (
                      <Select
                        ...
                        value={datasource_mod_modal.USER_TYPE}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceModModal({
                              ...datasource_mod_modal,
                  ...
                  },
                  {
                    ...
                    data_1: (
                      <Select
                        ...
                        value={datasource_mod_modal.WORK_TYPE}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceModModal({
                              ...datasource_mod_modal,
                  ...
                  },
                  {
                    ...
                    data_1: (
                      <Select
                        ...
                        style={{ width: "100%" }}
                        options={province}
                        value={datasource_mod_modal.PROVINCE_NUM}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceModModal({
                              ...datasource_mod_modal,
                  ...
                  },
                  {
                    ...
                    data_1: (
                      <Input
                        size="small"
                        value={datasource_mod_modal.EMAIL}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceModModal({
                              ...datasource_mod_modal,
                  ...
                  },
                  {
                    ...
                    data_1: (
                      <Input
                        size="small"
                        value={datasource_mod_modal.PHONE}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceModModal({
                              ...datasource_mod_modal,
                  ...
                  },
                  {
                    ...
                    data_1: (
                      <Select
                        ...
                        style={{ width: "100%" }}
                        options={auth}
                        value={datasource_mod_modal.AUTH_NUM}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceModModal({
                              ...datasource_mod_modal,
