...
//redux
import { setDataSource } from "../../../reducers/prd/prdProgressProgress";
import {
...
} from "../../../reducers/prd/prdProgressProgress_modal";
//
...
function Progress() {
  ...
  // 수정
  const { dataSource } = useSelector((state) => state.prdProgressProgress);
  const {
    // isvisible_search_modal,
    isvisible_modify_modal,
    isvisible_register_modal,
  } = useSelector((state) => state.prdProgressProgress_modal);
  ...
  return (
    <div>
      <Template
        ...
        Header_bottom={{
          title: "농약", //수정
          subTitle: "수입식품 중 농약잔류허용기준 설정 진행 사항", //수정
          datasource_breadcrumb: [
            ...
            {
              href: "/prd/progress",
              name: "수입식품 중 농약잔류허용기준 설정 진행사항", //수정
            },
            {
              href: "/prd/progress",
              name: "진행 사항", //수정
              ...
              columns={[
                {
                  ...
                  sorter: {
                    compare: (a, b, sortOrder) =>
                      customSorter(a, b, sortOrder, "PESTICIDE_NAME"),
                  },
                  showSorterTooltip: false,
                  sortDirections: ["ascend", "descend", "ascend"],
                  render: (data, row, index) => {
                    return <>{row.PESTICIDE_NAME}</>;
                  },
                },
                {
                  title: "대상식품",
                  ...
                  sorter: {
                    compare: (a, b, sortOrder) =>
                      customSorter(a, b, sortOrder, "FOOD_NAME"),
                  },
                  showSorterTooltip: false,
                  sortDirections: ["ascend", "descend", "ascend"],
                  render: (data, row, index) => {
                ...
                },
                {
                  ...
                  sorter: {
                    compare: (a, b, sortOrder) =>
                      customSorter(a, b, sortOrder, "APPLICATION_DATE"),
                  },
                  showSorterTooltip: false,
                  sortDirections: ["ascend", "descend", "ascend"],
                  defaultSortOrder: "descend",
                  render: (data, row, index) => {
                    return <>{row.APPLICATION_DATE}</>;
                  },
                },
                {
                  title: "검토완료예정일",
                  ...
                  sorter: {
                    compare: (a, b, sortOrder) =>
                      customSorter(a, b, sortOrder, "DUE_DATE_OF_COMPLETION"),
                  },
                  showSorterTooltip: false,
                  sortDirections: ["ascend", "descend", "ascend"],
                  defaultSortOrder: "ascend",
                  render: (data, row, index) => {
                    return <>{row.DUE_DATE_OF_COMPLETION}</>;
                  },
                },
                {
                  title: "신청회사",
                  ...
                  sorter: {
                    compare: (a, b, sortOrder) =>
                      customSorter(a, b, sortOrder, "APPLICATION_COMPANY"),
                  },
                  showSorterTooltip: false,
                  sortDirections: ["ascend", "descend", "ascend"],
                  render: (data, row, index) => {
                    return <>{row.APPLICATION_COMPANY}</>;
                  },
                },
                {
                  title: "비고",
                  ...
                  sorter: {
                    compare: (a, b, sortOrder) =>
                      customSorter(a, b, sortOrder, "COMMENTS"),
                  },
                  showSorterTooltip: false,
                  sortDirections: ["ascend", "descend", "ascend"],
                  defaultSortOrder: "ascend",
...
export const RegisterModal = () => {
  ...
  const { isvisible_register_modal, datasource_reg_modal } = useSelector(
    (state) => state.prdProgressProgress_modal
  );
  ...
  useEffect(() => {
    dispatch(
      setDatasourceRegModal({
        ...
        DUE_DATE_OF_COMPLETION: moment(new Date()).format("YYYY-MM-DD"),
                ...
                dataSource={[
                  {
                    ...
                    data_1: (
                      <Input
                        size="small"
                        value={datasource_reg_modal.PESTICIDE_NAME}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceRegModal({
                              ...datasource_reg_modal,
                  ...
                  },
                  {
                    ...
                    data_1: (
                      <Input
                        size="small"
                        value={datasource_reg_modal.APPLICATION_COMPANY}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceRegModal({
                              ...datasource_reg_modal,
                              APPLICATION_COMPANY: e.target.value,
                            })
                          );
                        }}
                      />
                    ...
                    data_2: (
                      <Input
                        size="small"
                        value={datasource_reg_modal.FOOD_NAME}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceRegModal({
                              ...datasource_reg_modal,
                  ...
                  },
                  {
                    ...
                    data_1: (
                      <DatePicker
                        size="small"
                        value={moment(
                          datasource_reg_modal.APPLICATION_DATE,
                          "YYYY-MM-DD"
                        )}
                        style={{ width: "100%" }}
                    ...
                    data_2: (
                      <DatePicker
                        size="small"
                        value={moment(
                          datasource_reg_modal.DUE_DATE_OF_COMPLETION,
                          "YYYY-MM-DD"
                        )}
                        style={{ width: "100%" }}
                        onChange={(date, dateString) => {
                          dispatch(
                            setDatasourceRegModal({
                              ...datasource_reg_modal,
                              DUE_DATE_OF_COMPLETION: dateString,
                            })
                          );
                        }}
                      />
                  ...
                  },
                  {
                    ...
                    data_1: (
                      <Input
                        size="small"
                        value={datasource_reg_modal.COMMENTS}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceRegModal({
                              ...datasource_reg_modal,
                ...
                dataSource={[
                  {
                    ...
                    data_1: (
                      <Input
                        size="small"
                        value={datasource_mod_modal.PESTICIDE_NAME}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceModModal({
                  ...
                  },
                  {
                    ...
                    data_1: (
                      <Input
                        size="small"
                        value={datasource_mod_modal.APPLICATION_COMPANY}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceModModal({
                              ...datasource_mod_modal,
                    ...
                    data_2: (
                      <Input
                        size="small"
                        value={datasource_mod_modal.FOOD_NAME}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceModModal({
                              ...datasource_mod_modal,
                  ...
                  },
                  {
                    ...
                    data_1: (
                      <DatePicker
                        size="small"
                        value={moment(
                          datasource_mod_modal.APPLICATION_DATE,
                          "YYYY-MM-DD"
                        )}
                        style={{ width: "100%" }}
                        onChange={(date, dateString) => {
                    ...
                    data_2: (
                      <DatePicker
                        size="small"
                        value={moment(
                          datasource_mod_modal.DUE_DATE_OF_COMPLETION,
                          "YYYY-MM-DD"
                        )}
                        style={{ width: "100%" }}
                        onChange={(date, dateString) => {
                  ...
                  },
                  {
                    ...
                    data_1: (
                      <Input
                        size="small"
                        value={datasource_mod_modal.COMMENTS}
                        onChange={(e) => {
                          dispatch(
                            setDatasourceModModal({
                              ...datasource_mod_modal,
