                      ...
                      render: (data, row, index) => {
                        return (
                          <a
                            ...
                            href={
                              "https://www.foodsafetykorea.go.kr/foodcode/" +
                              row.QUALITATIVE_URL_I
                            }
                          >
                            {row.QUALITATIVE_NUM_I}
                          </a>
                        );
                      },
                    },
                      ...
                      render: (data, row, index) => {
                        return (
                          <a
                            ...
                            href={
                              "https://www.foodsafetykorea.go.kr/foodcode/" +
                              row.QUANTITATIVE_URL_I
                            }
                          >
                            {row.QUANTITATIVE_NUM_I}
                          </a>
                        );
                      },
                    },
                    ...
                    <Row key={row.FOOD_CODE}>
                      <Col xs={12}>
                        <Button
                          ...
                          onClick={() => {
                            fetch(
                              "/API/search?TYPE=11512&PESTICIDE_CODE=" +
                                row.PESTICIDE_CODE +
                                "&NUM=" +
                                row.NUM,
                              {
                              ...
                              (resolve, reject) => {
                                fetch("/API/delete", {
                                  ...
                                  body: JSON.stringify({
                                    data: customEncrypt([
                                      {
                                        TABLE: "T_RESI_PESTICIDE_ANALYSIS_URL",
