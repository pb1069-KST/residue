...
export const SearchModal = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      "/API/search?TYPE=11122&PESTICIDE_CODE=" +
        datasource_sch_modal.PESTICIDE_CODE,
      {
        method: "GET",
        credentials: "include",
                  ...
                  data_1: (
                    <a
                      ...
                      href={
                        "https://www.foodsafetykorea.go.kr/foodcode/" +
                        analysisUrlA
                          ? analysisUrlA.QUALITATIVE_URL
                          : null
                      }
                    >
                      {analysisUrlA ? analysisUrlA.QUALITATIVE_NUM : null}
                    </a>
                  ),
                  wide: 1,
                },
                  ...
                  data_1: (
                    <a
                      ...
                      href={
                        "https://www.foodsafetykorea.go.kr/foodcode/" +
                        analysisUrlA
                          ? analysisUrlA.QUANTITATIVE_URL
                          : null
                      }
                    >
                      {analysisUrlA ? analysisUrlA.QUANTITATIVE_NUM : null}
                    </a>
                  ),
                  wide: 1,
                },
