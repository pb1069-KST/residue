                        ...
                        <Table
                            ...
                            columns={[
                                ...
                                },
                                {
                                    ...
                                    render: (data, row, index) => {
                                        return (
                                            data === 'P' ? <span style={{ color: "blue" }}>농약정보</span> : <span style={{ color: "green" }}>홍보자료</span>
                                        )
                                    },
                                },
                                {
                                    ...
                                    render: (data, row, index) => {
                                        return (
                                            <a
                                                onClick={() => {
                                                    fetch("/API/search?TYPE=41112&ARTICLE_KEY=" + row.ARTICLE_KEY, {
                                                        method: 'GET',
                                                        credentials: 'include',
                                                    }).then(function (response) {
                                                        return response.json();
...
export const SearchModal = () => {
    ...
    } = useSelector(state => state.DocPrdArticle); //수정
    // const xs_title = 7
    // const xs_input = 16
    ...
    const editorState = ContentState.createFromBlockArray(convertFromHTML(datasource_sch_modal.CONTENT))
    const temp = EditorState.createWithContent(editorState)
    useEffect(() => {
                                ...
                                columns={[
                                    ...
                                    },
                                    {
                                        ...
                                        render: (text, row, index) => {
                                            if (text === 'P') {
                                                return {
                                                    children: <span>농약정보</span>
                                                }
                                            }
                                            if (text === 'T') {
                                                return {
                                                    children: <span>홍보자료</span>
                                                }
                                            }
                                            if (row.wide === 0) {
                                                return {
                                ...
                                onConfirm={() => {
                                    fetch('/API/search?TYPE=41113', {
                                        ...
                                        var promise_using = new Promise((resolve, reject) => {
                                            ...
                                            datasource_reg_modal.CONTENT = draftToHtml(convertToRaw(editorState.getCurrentContent()))

                                            const html = datasource_reg_modal.CONTENT
                                            console.log(html) // html
                                            console.log(convertFromHTML(html))
                                            const editState2 = ContentState.createFromBlockArray(convertFromHTML(html))

                                            const temp = EditorState.createWithContent(editState2)
                                            console.log(temp)
                                            console.log(draftToHtml(convertToRaw(temp.getCurrentContent())))


                                            console.log(editorState)
                                            // const html2 = draftToHtml(convertToRaw(editState.getCurrentContent()))
                                            
                                            console.log(editState2) // 에디터스테이트
                                            // console.log(html2) // html



                                            // console.log(datasource_reg_modal)
                                ...
                                dataSource={[
                                    {
                                        ...
                                        //         { ...datasource_reg_modal, GBN_BRD: e,CLASS_M_CODE: "",CLASS_S_CODE: "" }
                                        //     ))
                                        ...
                                        // }}
                                        >
                                            <Option value={"P"}>농약정보</Option>
                                            <Option value={"T"}>홍보자료</Option>
...
export const ModifyModal = () => {
    ...
    const editorState = ContentState.createFromBlockArray(convertFromHTML(datasource_mod_modal.CONTENT))
    const temp = EditorState.createWithContent(editorState)
    // useEffect 제외
    // useEffect(() => {
    //     fetch('/API/search?TYPE=16111', {
                            ...
                            <Popconfirm
                                ...
                                onConfirm={() => {
                                    var promise_update = new Promise((resolve, reject) => {
                                        ...
                                        datasource_mod_modal.CONTENT = temp
