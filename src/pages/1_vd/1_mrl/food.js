              ...
              columns={[
                {
                  ...
                  render: (data, row, index) => {
                    if (
                      row.FOOD_NAME_KR === null ||
                      row.FOOD_NAME_KR.replace(" ", "") === ""
                    ) {
                      return <>{row.FOOD_NAME_EN}</>;
                    } else if (
                      row.FOOD_NAME_EN === null ||
                      row.FOOD_NAME_EN.replace(" ", "") === ""
                    ) {
                      return <>{row.FOOD_NAME_KR}</>;
                    } else {
                      return (
                        <>
                          {row.FOOD_NAME_KR}(
                ...
                },
                {
                  ...
                  render: (data, row, index) => {
                    if (
                      ...
                      row.CLASS_L_NAME_EN === null ||
                      row.CLASS_L_NAME_EN.replace(" ", "") === ""
                    ) {
                      return !(
                        row.CLASS_L_NAME_EN === null ||
                        row.CLASS_L_NAME_EN.replace(" ", "") === ""
                ...
                },
                {
                  ...
                  render: (data, row, index) => {
                    if (
                      ...
                      row.CLASS_M_NAME_EN === null ||
                      row.CLASS_M_NAME_EN.replace(" ", "") === ""
                    ) {
                      return !(
                        row.CLASS_M_NAME_EN === null ||
                        row.CLASS_M_NAME_EN.replace(" ", "") === ""
                ...
                },
                {
                  ...
                  render: (data, row, index) => {
                    if (
                      ...
                      row.CLASS_S_NAME_EN === null ||
                      row.CLASS_S_NAME_EN.replace(" ", "") === ""
                    ) {
                      return !(
                        row.CLASS_S_NAME_EN === null ||
                        row.CLASS_S_NAME_EN.replace(" ", "") === ""
                    ...
                    <Row key={row.FOOD_CODE}>
                      <Col xs={12}>
                        <Button
                          ...
                          onClick={() => {
                            fetch(
                              "/API/search?TYPE=22212&FOOD_CODE=" +
                                row.FOOD_CODE,
                              {
                                method: "GET",
                                credentials: "include",
                              ...
                              .then((myJson) => {
                                ...
                                fetch(
                                  "/API/search?TYPE=22216&CLASS_L_CODE=" +
                                ...
                                fetch(
                                  "/API/search?TYPE=22217&CLASS_L_CODE=" +
                                    myJson[0].CLASS_L_CODE +
                                    "&CLASS_M_CODE=" +
...
export const RegisterModal = () => {
  const dispatch = useDispatch();
  const { datasource_class_L, datasource_class_M, datasource_class_S } =
    useSelector((state) => state.VdMrlFood);
                    ...
                    .then((data) => {
                      var promise_using = new Promise((resolve, reject) => {
                        datasource_reg_modal.FOOD_CODE =
                          "vd" +
                          (parseInt(data[0].NUM.replace("vd", ""), 10) + 1);
                        datasource_reg_modal.TABLE = "T_RESI_VD_FOOD";
                      ...
                      <div>
                        <Select
                          ...
                          onChange={(e) => {
                            ...
                            fetch("/API/search?TYPE=22216&CLASS_L_CODE=" + e, {
                              method: "GET",
                              credentials: "include",
                            })
                              .then(function (response) {
              ...
              <Popconfirm
                ...
                onConfirm={() => {
                  var promise_update = new Promise((resolve, reject) => {
                    datasource_mod_modal.TABLE = "T_RESI_VD_FOOD";
