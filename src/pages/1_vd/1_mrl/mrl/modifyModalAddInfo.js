                ...
                onConfirm={() => {
                  fetch("/API/search?TYPE=92112", {
                    ...
                    .then((max) => {
                      ...
                      if (temp.length === 0) {
                        var insertTemp = customEncrypt(temp);
                        fetch("/API/insert", {
                          method: "POST",
                          body: JSON.stringify({ data: insertTemp }),
                          headers: {
                        ...
                        var insertTemp = customEncrypt([
                          {
                            TABLE: "T_RESI_VD_VDRUG_MRL_ADDITIONAL_INFORMATION",
                            KEY: ["DELETE_ALL"],
                            DELETE_ALL: "N",
                          },
                        ]);
