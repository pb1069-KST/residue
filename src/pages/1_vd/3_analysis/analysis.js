...
//redux
import { setDataSource } from "../../../reducers/vd/VdAnalysisAnalysis";
import {
...
} from "../../../reducers/vd/VdAnalysisAnalysis_modal";
//
...
// import { customEncrypt } from "../0_info/using";
...
function Food() {
  ...
  const { dataSource } = useSelector((state) => state.VdAnalysisAnalysis);
  const {
    isvisible_modify_modal,
    isvisible_register_modal,
    // datasource_class_L,
    // datasource_mod_modal
  } = useSelector((state) => state.VdAnalysisAnalysis_modal);
              ...
              columns={[
                ...
                },
                {
                  ...
                  children: [
                    {
                      title: "정성",
                      dataIndex: "QUALITATIVE_NUM_A",
                      key: "VDRUG_CODE",
                      width: "15%",
                      sorter: {
                        compare: (a, b, sortOrder) =>
                          customSorter(a, b, sortOrder, "QUALITATIVE_NUM_A"),
                      },
                      showSorterTooltip: false,
                      sortDirections: ["ascend", "descend", "ascend"],
                      defaultSortOrder: "ascend",
                        ...
                        return (
                          <a
                            ...
                            href={
                              ...
                              row.QUALITATIVE_URL_A
                            }
                          >
                            {row.QUALITATIVE_NUM_A}
                          </a>
                        );
                      },
                    },
                    {
                      title: "정량",
                      dataIndex: "QUANTITATIVE_NUM_A",
                      key: "VDRUG_CODE",
                      width: "15%",
                      sorter: {
                        compare: (a, b, sortOrder) =>
                          customSorter(a, b, sortOrder, "QUANTITATIVE_NUM_A"),
                      },
                      showSorterTooltip: false,
                      sortDirections: ["ascend", "descend", "ascend"],
                      defaultSortOrder: "ascend",
                      render: (data, row, index) => {
                        return (
                          <a
                            ...
                            href={
                              "https://www.foodsafetykorea.go.kr/foodcode/" +
                              row.QUANTITATIVE_URL_A
                            }
                          >
                            {row.QUANTITATIVE_NUM_A}
                          </a>
                        );
                      },
                    },
                ...
                },
                {
                  ...
                  children: [
                    {
                      title: "정성",
                      dataIndex: "QUALITATIVE_NUM_F",
                      key: "VDRUG_CODE",
                      width: "15%",
                      sorter: {
                        compare: (a, b, sortOrder) =>
                          customSorter(a, b, sortOrder, "QUALITATIVE_NUM_F"),
                      },
                      showSorterTooltip: false,
                      sortDirections: ["ascend", "descend", "ascend"],
                      defaultSortOrder: "ascend",
                      render: (data, row, index) => {
                        return (
                          <a
                            ...
                            href={
                              "https://www.foodsafetykorea.go.kr/foodcode/" +
                              row.QUALITATIVE_URL_F
                            }
                          >
                            {row.QUALITATIVE_NUM_F}
                          </a>
                        );
                      },
                    },
                    {
                      title: "정량",
                      dataIndex: "QUANTITATIVE_NUM_F",
                      key: "VDRUG_CODE",
                      width: "15%",
                      sorter: {
                        compare: (a, b, sortOrder) =>
                          customSorter(a, b, sortOrder, "QUANTITATIVE_NUM_F"),
                      },
                      showSorterTooltip: false,
                      sortDirections: ["ascend", "descend", "ascend"],
                      defaultSortOrder: "ascend",
                      render: (data, row, index) => {
                        return (
                          <a
                            ...
                            href={
                              "https://www.foodsafetykorea.go.kr/foodcode/" +
                              row.QUANTITATIVE_URL_F
                            }
                          >
                            {row.QUANTITATIVE_NUM_F}
                          </a>
                        );
                      },
                    },
                ...
                },
                {
                  ...
                  children: [
                    {
                      title: "정량",
                      dataIndex: "QUANTITATIVE_NUM_ETC",
                      key: "VDRUG_CODE",
                      width: "15%",
                      sorter: {
                        compare: (a, b, sortOrder) =>
                          customSorter(a, b, sortOrder, "QUANTITATIVE_NUM_ETC"),
                      },
                      showSorterTooltip: false,
                      sortDirections: ["ascend", "descend", "ascend"],
                      defaultSortOrder: "ascend",
                      render: (data, row, index) => {
                        return (
                          <a
                            ...
                            href={
                              "https://www.foodsafetykorea.go.kr/foodcode/" +
                              row.QUANTITATIVE_URL_ETC
                            }
                          >
                            {row.QUANTITATIVE_NUM_ETC}
                          </a>
                        );
                      },
                    },
                    ...
                    <Row key={row.FOOD_CODE}>
                      <Col xs={12}>
                        <Button
                          ...
                          onClick={() => {
                            fetch(
                              "/API/search?TYPE=21512&VDRUG_CODE=" +
                                row.VDRUG_CODE +
                                "&NUM=" +
                                row.NUM,
                              {
                              ...
                              (resolve, reject) => {
                                fetch("/API/delete", {
                                  ...
                                  body: JSON.stringify({
                                    data: customEncrypt([
                                      {
                                        TABLE: "T_RESI_VD_VDRUG_ANALYSIS_URL",
                                        KEY: ["NUM", "VDRUG_CODE"],
                                        NUMERIC_KEY: ["NUM"],
                                        NUM: row.NUM,
                    ...
                    .then((data) => {
                      var promise_using = new Promise((resolve, reject) => {
                        ...
                        datasource_reg_modal.TABLE =
                          "T_RESI_VD_VDRUG_ANALYSIS_URL";
                        delete datasource_reg_modal.VDRUG_NAME_KR;
                        delete datasource_reg_modal.VDRUG_NAME_EN;
...
export const ModifyModal = () => {
  ...
  const { isvisible_modify_modal, datasource_mod_modal } = useSelector(
    (state) => state.VdAnalysisAnalysis_modal
  );
  // const xs_title = 7
  // const xs_input = 16
              ...
              <Popconfirm
                ...
                onConfirm={() => {
                  var promise_update = new Promise((resolve, reject) => {
                    datasource_mod_modal.TABLE = "T_RESI_VD_VDRUG_ANALYSIS_URL";
                    datasource_mod_modal.KEY = ["NUM", "VDRUG_CODE"];
                    datasource_mod_modal.NUMERIC_KEY = ["NUM"];

                    var VDRUG_NAME_KR_TEMP = datasource_mod_modal.VDRUG_NAME_KR;
                    var VDRUG_NAME_EN_TEMP = datasource_mod_modal.VDRUG_NAME_EN;

                    delete datasource_mod_modal.VDRUG_NAME_KR;
                    delete datasource_mod_modal.VDRUG_NAME_EN;
                    ...
                    fetch("/API/update", {
                      ...
                      if (response.status === 200) {
                        message.success(
                          "농약 분석법: " +
                            (VDRUG_NAME_KR_TEMP || VDRUG_NAME_EN_TEMP) +
                            "을 수정하였습니다."
                        );
                        dispatch(setIsvisibleModModal(false));
                        dispatch(setDatasourceModModal({}));
...
export const DrawerReg = () => {
  ...
  if (!isvisible_register_drawer) return <></>;
    ...
    return (
      <Drawer
        title={<span style={{ color: "white" }}>동물용의약품명 조회</span>}
        // footer={
        //     <div>
        //         <Button
        //             size="small"
