...
//redux
import { setDataSource } from "../../../reducers/vd/VdInfoUsing";
import {
  setIsvisibleModModal,
  setIsvisibleRegModal,
  setDatasourceRegModal,
  setDatasourceModModal,
} from "../../../reducers/vd/VdInfoUsing_modal";
//
...
function Using() {
  ...
  const { dataSource } = useSelector((state) => state.VdInfoUsing);
  const { isvisible_modify_modal, isvisible_register_modal } = useSelector(
    (state) => state.VdInfoUsing_modal
  );
              ...
              columns={[
                    ...
                    <Row key={row.USING_NUM}>
                      <Col xs={12}>
                        <Button
                          ...
                          onClick={() => {
                            fetch(
                              "/API/search?TYPE=21213&USING_NUM=" +
                                row.USING_NUM,
                              {
                                method: "GET",
                                credentials: "include",
                ...
                if (
                  ...
                  (userinfo.USERID === undefined ||
                    (userinfo.VD_USING_REG === "N" &&
                      userinfo.VD_USING_MOD === "N"))
                ) {
                  return false;
                } else {
                  return true;
                  ...
                  fetch("/API/search?TYPE=21212", {
                    ...
                    .then((data) => {
                      var promise_using = new Promise((resolve, reject) => {
                        ...
                        datasource_reg_modal.TABLE = "T_RESI_VD_VDRUG_USING";
              ...
              <Popconfirm
                ...
                onConfirm={() => {
                  var promise_update = new Promise((resolve, reject) => {
                    datasource_mod_modal.TABLE = "T_RESI_VD_VDRUG_USING";
