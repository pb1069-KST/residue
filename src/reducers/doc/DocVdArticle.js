export const DATASOURCE = "DOC/VDARTICLE/DATASOURCE";
export const ISVISIBLE_SCH_MODAL = "DOC/VDARTICLE/ISVISIBLE_SCH_MODAL";
export const ISVISIBLE_REG_MODAL = "DOC/VDARTICLE/ISVISIBLE_REG_MODAL";
export const ISVISIBLE_MOD_MODAL = "DOC/VDARTICLE/ISVISIBLE_MOD_MODAL";

export const SELECTED_MOD_MODAL = "DOC/VDARTICLE/SELECTED_MOD_MODAL";

export const DATASOURCE_SCH_MODAL = "DOC/VDARTICLE/DATASOURCE_SCH_MODAL";
export const DATASOURCE_REG_MODAL = "DOC/VDARTICLE/DATASOURCE_REG_MODAL";
export const DATASOURCE_MOD_MODAL = "DOC/VDARTICLE/DATASOURCE_MOD_MODAL";

export const DATASOURCE_REG_DRAWER = "DOC/VDARTICLE/DATASOURCE_REG_DRAWER";
export const ISVISIBLE_REG_DRAWER = "DOC/VDARTICLE/ISVISIBLE_REG_DRAWER";
...
const DocVdArticle = (state = initalState, action) => {
    // console.log(action)
    switch (action.type) {
        case DATASOURCE:
            return {
