export const DATASOURCE = "DOC/VDRELATED/DATASOURCE";
export const ISVISIBLE_SCH_MODAL = "DOC/VDRELATED/ISVISIBLE_SCH_MODAL";
export const ISVISIBLE_REG_MODAL = "DOC/VDRELATED/ISVISIBLE_REG_MODAL";
export const ISVISIBLE_MOD_MODAL = "DOC/VDRELATED/ISVISIBLE_MOD_MODAL";

export const SELECTED_MOD_MODAL = "DOC/VDRELATED/SELECTED_MOD_MODAL";

export const DATASOURCE_SCH_MODAL = "DOC/VDRELATED/DATASOURCE_SCH_MODAL";
export const DATASOURCE_REG_MODAL = "DOC/VDRELATED/DATASOURCE_REG_MODAL";
export const DATASOURCE_MOD_MODAL = "DOC/VDRELATED/DATASOURCE_MOD_MODAL";

export const DATASOURCE_REG_DRAWER = "DOC/VDRELATED/DATASOURCE_REG_DRAWER";
export const ISVISIBLE_REG_DRAWER = "DOC/VDRELATED/ISVISIBLE_REG_DRAWER";
...
const DocVdRelated = (state = initalState, action) => {
    // console.log(action)
    switch (action.type) {
        case DATASOURCE:
            return {
