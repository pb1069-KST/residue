export const DATASOURCE = "ADMIN/AUTH/DATASOURCE";
export const ISVISIBLE_SCH_MODAL = "ADMIN/AUTH/ISVISIBLE_SCH_MODAL";
export const ISVISIBLE_REG_MODAL = "ADMIN/AUTH/ISVISIBLE_REG_MODAL";
export const ISVISIBLE_MOD_MODAL = "ADMIN/AUTH/ISVISIBLE_MOD_MODAL";

export const SELECTED_MOD_MODAL = "ADMIN/AUTH/SELECTED_MOD_MODAL";

export const DATASOURCE_SCH_MODAL = "ADMIN/AUTH/DATASOURCE_SCH_MODAL";
export const DATASOURCE_REG_MODAL = "ADMIN/AUTH/DATASOURCE_REG_MODAL";
export const DATASOURCE_MOD_MODAL = "ADMIN/AUTH/DATASOURCE_MOD_MODAL";

export const DATASOURCE_REG_DRAWER = "ADMIN/AUTH/DATASOURCE_REG_DRAWER";
export const ISVISIBLE_REG_DRAWER = "ADMIN/AUTH/ISVISIBLE_REG_DRAWER";
...
const AdminAdminAuth = (state = initalState, action) => {
    // console.log(action)
    switch (action.type) {
        case DATASOURCE:
            return {
