export const DATASOURCE = "ADMIN/USER/DATASOURCE";
export const ISVISIBLE_SCH_MODAL = "ADMIN/USER/ISVISIBLE_SCH_MODAL";
export const ISVISIBLE_REG_MODAL = "ADMIN/USER/ISVISIBLE_REG_MODAL";
export const ISVISIBLE_MOD_MODAL = "ADMIN/USER/ISVISIBLE_MOD_MODAL";

export const SELECTED_MOD_MODAL = "ADMIN/USER/SELECTED_MOD_MODAL";

export const DATASOURCE_SCH_MODAL = "ADMIN/USER/DATASOURCE_SCH_MODAL";
export const DATASOURCE_REG_MODAL = "ADMIN/USER/DATASOURCE_REG_MODAL";
export const DATASOURCE_MOD_MODAL = "ADMIN/USER/DATASOURCE_MOD_MODAL";

export const DATASOURCE_REG_DRAWER = "ADMIN/USER/DATASOURCE_REG_DRAWER";
export const ISVISIBLE_REG_DRAWER = "ADMIN/USER/ISVISIBLE_REG_DRAWER";
...
const AdminAdminUser = (state = initalState, action) => {
    // console.log(action)
    switch (action.type) {
        case DATASOURCE:
            return {
