export const DATASOURCE = "TEMPLATE/TEMPLATE/DATASOURCE";
export const ISVISIBLE_SCH_MODAL = "TEMPLATE/TEMPLATE/ISVISIBLE_SCH_MODAL";
export const ISVISIBLE_REG_MODAL = "TEMPLATE/TEMPLATE/ISVISIBLE_REG_MODAL";
export const ISVISIBLE_MOD_MODAL = "TEMPLATE/TEMPLATE/ISVISIBLE_MOD_MODAL";

export const SELECTED_MOD_MODAL = "PRD/PROGRESS/SELECTED_MOD_MODAL";

export const DATASOURCE_SCH_MODAL = "TEMPLATE/TEMPLATE/DATASOURCE_SCH_MODAL";
export const DATASOURCE_REG_MODAL = "TEMPLATE/TEMPLATE/DATASOURCE_REG_MODAL";
export const DATASOURCE_MOD_MODAL = "TEMPLATE/TEMPLATE/DATASOURCE_MOD_MODAL";
...
const templateTemplateTemplate = (state = initalState, action) => {
    // console.log(action)
    switch (action.type) {
        case DATASOURCE:
            return {
        ...
        case ISVISIBLE_SCH_MODAL:
            return {
                ...state,
                isvisible_register_modal: action.isvisible_search_modal
            };    
...
export default templateTemplateTemplate;