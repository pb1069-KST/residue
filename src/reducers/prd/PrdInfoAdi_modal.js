export const ISVISIBLE_REG_MODAL = "PRD/ADI/ISVISIBLE_REG_MODAL";
export const ISVISIBLE_MOD_MODAL = "PRD/ADI/ISVISIBLE_MOD_MODAL";

export const SELECTED_MOD_MODAL = "PRD/ADI/SELECTED_MOD_MODAL";

export const DATASOURCE_REG_MODAL = "PRD/ADI/DATASOURCE_REG_MODAL";
export const DATASOURCE_MOD_MODAL = "PRD/ADI/DATASOURCE_MOD_MODAL";

export const SELECTED_DATA = "PRD/ADI/SELECTED_DATA";
...
const PrdInfoAdi_modal = (state = initalState, action) => {
    // console.log(action)
    switch (action.type) {
...
export default PrdInfoAdi_modal;