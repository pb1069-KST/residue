export const DATASOURCE = "STD/INPUT/DATASOURCE";
export const ISVISIBLE_SCH_MODAL = "STD/INPUT/ISVISIBLE_SCH_MODAL";
export const ISVISIBLE_REG_MODAL = "STD/INPUT/ISVISIBLE_REG_MODAL";
export const ISVISIBLE_MOD_MODAL = "STD/INPUT/ISVISIBLE_MOD_MODAL";

export const SELECTED_MOD_MODAL = "STD/INPUT/SELECTED_MOD_MODAL";

export const DATASOURCE_SCH_MODAL = "STD/INPUT/DATASOURCE_SCH_MODAL";
export const DATASOURCE_REG_MODAL = "STD/INPUT/DATASOURCE_REG_MODAL";
export const DATASOURCE_MOD_MODAL = "STD/INPUT/DATASOURCE_MOD_MODAL";

export const DATASOURCE_REG_DRAWER = "STD/INPUT/DATASOURCE_REG_DRAWER";
export const ISVISIBLE_REG_DRAWER = "STD/INPUT/ISVISIBLE_REG_DRAWER";
...
const StdStandardInput = (state = initalState, action) => {
    // console.log(action)
    switch (action.type) {
        case DATASOURCE:
            return {
...
export default StdStandardInput;