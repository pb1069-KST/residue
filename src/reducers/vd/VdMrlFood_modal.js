export const ISVISIBLE_REG_MODAL = "VD/FOOD/ISVISIBLE_REG_MODAL";
export const ISVISIBLE_MOD_MODAL = "VD/FOOD/ISVISIBLE_MOD_MODAL";

export const SELECTED_MOD_MODAL = "VD/FOOD/SELECTED_MOD_MODAL";

export const DATASOURCE_REG_MODAL = "VD/FOOD/DATASOURCE_REG_MODAL";
export const DATASOURCE_MOD_MODAL = "VD/FOOD/DATASOURCE_MOD_MODAL";
...
const vdMrlFood_modal = (state = initalState, action) => {
    // console.log(action)
    switch (action.type) {
...
export default vdMrlFood_modal;