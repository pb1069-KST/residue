export const DATASOURCE = "VD/INFO/DATASOURCE";
export const SELECTED_DATA = "VD/INFO/SELECTED_DATA";

export const ISVISIBLE_SCH_MODAL = "VD/INFO/ISVISIBLE_SCH_MODAL";
export const ISVISIBLE_REG_MODAL = "VD/INFO/ISVISIBLE_REG_MODAL";
export const ISVISIBLE_MOD_MODAL = "VD/INFO/ISVISIBLE_MOD_MODAL";

export const DATASOURCE_SCH_MODAL = "VD/INFO/DATASOURCE_SCH_MODAL";
export const DATASOURCE_SCH_MODAL_MRL = "VD/INFO/DATASOURCE_SCH_MODAL_MRL";
export const DATASOURCE_REG_MODAL = "VD/INFO/DATASOURCE_REG_MODAL";
export const DATASOURCE_MOD_MODAL = "VD/INFO/DATASOURCE_MOD_MODAL";
export const DATASOURCE_MOD_MODAL_ORG = "VD/INFO/DATASOURCE_MOD_MODAL_ORG";

export const USING_ARRAY = "VD/INFO/USING_ARRAY";
...
const VDInfoInfo = (state = initalState, action) => {
  // console.log(action)
  switch (action.type) {
    case DATASOURCE:
      return {
