...
export const ISVISIBLE_MOD_MODAL_ADD_INFO =
  "VD/MRL/ISVISIBLE_MOD_MODAL_ADD_INFO";
...
export const ISVISIBLE_MOD_MODAL_ADD_INFO2 =
  "VD/MRL/ISVISIBLE_MOD_MODAL_ADD_INFO2";
...
export const ISVISIBLE_MOD_DRAWER_MOD = "VD/MRL/ISVISIBLE_MOD_DRAWER_MOD";
...
export const SELECTED_MODAL_DATA = "VD/MRL/SELECTED_MODAL_DATA";
...
const VdMrlMrl_modal = (state = initalState, action) => {
  // console.log(action)
  switch (action.type) {
