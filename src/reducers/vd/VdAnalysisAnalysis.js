export const DATASOURCE = "VD/ANALYSIS/DATASOURCE";
export const ISVISIBLE_SCH_MODAL = "VD/ANALYSIS/ISVISIBLE_SCH_MODAL";
export const ISVISIBLE_REG_MODAL = "VD/ANALYSIS/ISVISIBLE_REG_MODAL";
export const ISVISIBLE_MOD_MODAL = "VD/ANALYSIS/ISVISIBLE_MOD_MODAL";

export const SELECTED_MOD_MODAL = "VD/ANALYSIS/SELECTED_MOD_MODAL";

export const DATASOURCE_SCH_MODAL = "VD/ANALYSIS/DATASOURCE_SCH_MODAL";
export const DATASOURCE_REG_MODAL = "VD/ANALYSIS/DATASOURCE_REG_MODAL";
export const DATASOURCE_REG_MODAL_ANALYSIS =
  "VD/ANALYSIS/DATASOURCE_REG_MODAL_ANALYSIS";
export const DATASOURCE_MOD_MODAL = "VD/ANALYSIS/DATASOURCE_MOD_MODAL";
export const DATASOURCE_MOD_MODAL_ANALYSIS =
  "VD/ANALYSIS/DATASOURCE_MOD_MODAL_ANALYSIS";

export const DATASOURCE_REG_DRAWER = "VD/ANALYSIS/DATASOURCE_REG_DRAWER";
export const ISVISIBLE_REG_DRAWER = "VD/ANALYSIS/ISVISIBLE_REG_DRAWER";
export const ISVISIBLE_MOD_DRAWER = "VD/ANALYSIS/ISVISIBLE_MOD_DRAWER";
...
export const setDatasourceRegModalAnalysis = (
  datasource_reg_modal_analysis
) => ({ type: DATASOURCE_REG_MODAL_ANALYSIS, datasource_reg_modal_analysis });

export const setDatasourceModModal = (datasource_mod_modal) => ({
  type: DATASOURCE_MOD_MODAL,
  datasource_mod_modal,
});
export const setDatasourceModModalAnalysis = (
  datasource_mod_modal_analysis
) => ({ type: DATASOURCE_MOD_MODAL_ANALYSIS, datasource_mod_modal_analysis });

export const setDatasourceRegDrawer = (datasource_reg_drawer) => ({
  type: DATASOURCE_REG_DRAWER,
  datasource_reg_drawer,
});
export const setIsvisibleRegDrawer = (isvisible_register_drawer) => ({
  type: ISVISIBLE_REG_DRAWER,
...
const VdAnalysisAnalysis = (state = initalState, action) => {
  // console.log(action)
  switch (action.type) {
    case DATASOURCE:
      return {
    ...
    case DATASOURCE_REG_MODAL_ANALYSIS:
      return {
        ...state,
        datasource_reg_modal_analysis: action.datasource_reg_modal_analysis,
      };
    ...
    case DATASOURCE_MOD_MODAL_ANALYSIS:
      return {
        ...state,
        datasource_mod_modal_analysis: action.datasource_mod_modal_analysis,
      };
...
export default VdAnalysisAnalysis;
