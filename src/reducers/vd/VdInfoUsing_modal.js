export const ISVISIBLE_REG_MODAL = "VD/USING/ISVISIBLE_REG_MODAL";
export const ISVISIBLE_MOD_MODAL = "VD/USING/ISVISIBLE_MOD_MODAL";

export const SELECTED_MOD_MODAL = "VD/USING/SELECTED_MOD_MODAL";

export const DATASOURCE_REG_MODAL = "VD/USING/DATASOURCE_REG_MODAL";
export const DATASOURCE_MOD_MODAL = "VD/USING/DATASOURCE_MOD_MODAL";
...
const VdInfoUsing_modal = (state = initalState, action) => {
    // console.log(action)
    switch (action.type) {
...
export default VdInfoUsing_modal;